...
Hit "Submit Code" to create the variable `x1`.
...
Hit "Submit Code" to create the `x2` variable, another character vector. But note the misspelling of "Jan" as "Jam".
...
The next exercises will be focusing on the variable `csv`. Hit "Submit Code" to look at `csv`.
...
Type `gss_cat` and hit "Submit Code."
