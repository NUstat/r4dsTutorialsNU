...
```{r coding-basics-1a, exercise = TRUE}

```

```{r coding-basics-1a-hint-1, eval = FALSE}
___ <- __ * ___
x
```

```{r coding-basics-1a-solution, exercise.reveal_solution = FALSE}
x <- 2 * 8
```

```{r coding-basics-1a-check}
grade_this_code()
```
...
```{r coding-basics-1b, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r coding-basics-1b-hint-1, eval = FALSE}
x <- 2 * 8
sqrt(...)
```

```{r coding-basics-1b-solution, exercise.reveal_solution = FALSE}
x <- 2 * 8
sqrt(x)
```

```{r coding-basics-1b-check}
grade_this_code()
```
...
```{r coding-basics-1c, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r coding-basics-1c-hint-1, eval = FALSE}
x <- 2 * 8
sqrt(...)
```

```{r coding-basics-1c-solution, exercise.reveal_solution = FALSE}
x <- 2 * 8
sqrt(x)
```

```{r coding-basics-1c-check}
grade_this_code()
```
...
```{r coding-basics-2a, exercise = TRUE}

```

```{r coding-basics-2a-hint-1, eval = FALSE}
___ <- c(2, 4, 6, 8)
```

```{r coding-basics-2a-solution, exercise.reveal_solution = FALSE}
even <- c(2, 4, 6, 8)
```

```{r coding-basics-2a-check}
grade_this_code()
```
...
```{r coding-basics-2b, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r coding-basics-2b-hint-1, eval = FALSE}
even <- c(2, 4, 6, 8)
even ___ ___
```

```{r coding-basics-2b-solution, exercise.reveal_solution = FALSE}
even <- c(2, 4, 6, 8)
even / 2
```

```{r coding-basics-2b-check}
grade_this({
