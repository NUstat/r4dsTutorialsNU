...
We will be downloading a 9 gb data file in this reading tutorial. If you do not have more than 15 GB of storage on your computer, we suggest completing this reading tutorial on an alternative computer if at all possible. Otherwise, as you work through the materials make note that you weren't able to run things because you weren't able to download the data. 

You'll want to complete this reading tutorial in one sitting otherwise you will have to download the large file again (which takes at least 5 mins). It is stored in a temporary folder while working on the reading tutotrial and when you quit R/RStudio the file will be deleted (freeing up your storage).
