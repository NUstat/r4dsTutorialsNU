...
question_wordbank("Match the variable name with its description.",
       choices = c("price in US dollars", "weight of the diamond", "quality of the cut", "length in mm", "width in mm", "depth in mm"),
       arrange = "ordered",
       box = 8,
...
Now pipe the variable `smaller` to `ggplot()`. 
...
```{r variation-16-solution, exercise.reveal_solution = FALSE}
diamonds |> 
  filter(y < 3 | y > 20) |> 
  select(price, x, y, z) |> 
  arrange(y)
