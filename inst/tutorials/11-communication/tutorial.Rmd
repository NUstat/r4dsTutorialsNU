...
Type in `labels_tib` and hit "Submit Code". 
...
There are two possible sources of labels. First, you might have a tibble that provides labels. Type `label_info` and hit "Submit Code".
...
Type `potential_outliers` and hit "Submit Code". 
