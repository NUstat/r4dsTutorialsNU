...
Run and submit `flights$tailnum`.
...
Run and submit `flights$carrier`.
...
Hit Submit Answer to create the tibbles we will use to demonstrate or visualize the images in the upcoming exercises.
