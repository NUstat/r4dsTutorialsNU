...
After loading `readxl`, look up the help page for the package by running this command: <code>?\`readxl-package\`</code>. Copy/paste the Description field from the help page.  
...
You can create a brand new sheet with [`gs4_create()`](https://googlesheets4.tidyverse.org/reference/gs4_create.html) or write to an existing sheet with [`sheet_write()`](https://googlesheets4.tidyverse.org/articles/write-sheets.html) and share with friends.
