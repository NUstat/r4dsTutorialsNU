...
We will explore the `oecd_sum` data set further. Go to [this website](https://kjhealy.github.io/socviz/reference/oecd_sum.html). 

https://kjhealy.github.io/socviz/reference/oecd_sum.html

Copy and paste what the `hi_lo` and `diff` variables represent.
...
<!-- DK: Somewhat annoying that we can't just copy code from above, given the written question that was asked in previous question. -->
