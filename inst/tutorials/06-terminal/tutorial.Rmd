...
In the previous section we created a folder that contains a script. However, how do we guarantee when we exit out of R Studio and re-open it that we will be working in the correct directory?
...
Creating/opening an R project moves the R session to that directory.
...
This tutorial covered [Chapter 6 Workflow: scripts and projects](https://r4ds.hadley.nz/workflow-style.html) from [*R for Data Science (2e)*](https://r4ds.hadley.nz/) by Hadley Wickham, Mine Çetinkaya-Rundel, and Garrett Grolemund. You learned...
